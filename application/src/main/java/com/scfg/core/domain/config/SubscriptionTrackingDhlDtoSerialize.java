...
public class SubscriptionTrackingDhlDtoSerialize extends StdSerializer<SubscriptionTrackingDhlDTO> {

    public SubscriptionTrackingDhlDtoSerialize() {
        this(null);
    }

    protected SubscriptionTrackingDhlDtoSerialize(Class<SubscriptionTrackingDhlDTO> t) {
        super(t);
    }

    @Override
    public void serialize(SubscriptionTrackingDhlDTO value, JsonGenerator jgen, SerializerProvider provider) throws IOException {
        jgen.writeStartObject();
        jgen.writeObjectField("CORRELATIVO_CONTROL", value.getCORRELATIVO_CONTROL());
        jgen.writeObjectField("ITEM", value.getITEM());
        jgen.writeObjectField("FECHA_RECEPCION_DJS_REQUERIMIENTO", getValueObject(value.getFECHA_RECEPCION_DJS_REQUERIMIENTO()));
        ...
        jgen.writeObjectField("CEDULA_IDENTIDAD", value.getCEDULA_IDENTIDAD());
        jgen.writeObjectField("EX", value.getEX());
        ...
        jgen.writeObjectField("CARTA_RECHAZO_EXCLUSION", value.getCARTA_RECHAZO_EXCLUSION());
        jgen.writeObjectField("RIESGO", value.getRIESGO());
        jgen.writeObjectField("PORCENTAJE_EXTRAPRIMA", value.getPORCENTAJE_EXTRAPRIMA());
