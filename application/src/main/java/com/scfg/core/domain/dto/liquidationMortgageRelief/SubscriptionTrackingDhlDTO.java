...
@Getter
@Setter
@JsonSerialize(using = SubscriptionTrackingDhlDtoSerialize.class)
public class SubscriptionTrackingDhlDTO {
    ...
    @JsonProperty("FECHA_RECEPCION_DJS_REQUERIMIENTO")
    @JsonFormat(pattern = "dd/MM/yyyy")
    private LocalDate FECHA_RECEPCION_DJS_REQUERIMIENTO;
    ...
    @JsonProperty("CARTA_RECHAZO_EXCLUSION")
    private String CARTA_RECHAZO_EXCLUSION;
    ...
    public SubscriptionTrackingDhlDTO(){}

    @Builder
    public SubscriptionTrackingDhlDTO(Long CORRELATIVO_CONTROL, String ITEM, LocalDate FECHA_RECEPCION_DJS_REQUERIMIENTO, LocalDate FECHA_LLENADO_DJS, String NRO_DECLARACION, Long NRO_OPERACION,String ASEGURADO, String GENERO, String CEDULA_IDENTIDAD, String EX, LocalDate FECHA_NACIMIENTO, String MONEDA, Double MONTO_SOLICITADO_BS, Double MONTO_ACUMULADO_BS, String REQUISITOS, LocalDate FECHA_CUMPLIMIENTO_REQUISITOS, String ESTADO, String CAUSA, String COMENTARIOS_ADICIONALES, LocalDate FECHA_PRONUNCIAMIENTO_AL_BANCO, LocalDate FECHA_DESEMBOLSO, Integer TIEMPO_VALIDEZ_DJS, Integer TIEMPO_RESPUESTA, String CARTA_RECHAZO_EXCLUSION, String RIESGO, Double PORCENTAJE_EXTRAPRIMA, String MOTIVO_EXTRAPRIMA, String COBERTURA_OTORGADA, String DETALLE_MOTIVO, String EXAMENES_REALIZADOS, String OFICINA, String SUCURSAL_OFICINA, String GESTOR, String TIPO_REQUERIMIENTO, LocalDate FECHA_ENVIO_REASEGURO, String TIPO_OPERACION, LocalDate FECHA_RESPUESTA, Integer TIEMPO_RESPUESTA_REASEGURO, Double CAPITAL_ASEGURADO_BS, String NIVEL, Integer PLAZO_CREDITO_MESES, LocalDate FECHA_EMISION, String COMENTARIOS, String PROCESO, LocalDate FECHA_AGENDAMIENTO) {
        this.CORRELATIVO_CONTROL = CORRELATIVO_CONTROL;
        this.ITEM = ITEM;
        this.FECHA_RECEPCION_DJS_REQUERIMIENTO = FECHA_RECEPCION_DJS_REQUERIMIENTO;
        ...
        this.CARTA_RECHAZO_EXCLUSION = CARTA_RECHAZO_EXCLUSION;
        this.RIESGO = RIESGO;
    ...
    public SubscriptionTrackingDhlDTO hiddenRelationship(){
