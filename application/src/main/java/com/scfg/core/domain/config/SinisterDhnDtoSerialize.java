...
public class SinisterDhnDtoSerialize extends StdSerializer<SinisterDhnDTO> {

    public SinisterDhnDtoSerialize() {
        this(null);
    }

    protected SinisterDhnDtoSerialize(Class<SinisterDhnDTO> t) {
        super(t);
    }

    @Override
    public void serialize(SinisterDhnDTO value, JsonGenerator jgen, SerializerProvider provider) throws IOException {
