...
import com.scfg.core.domain.common.ReferencePerson;
...
public class NewPerson extends BaseDomain {
    ...
    @ApiModelProperty(notes = "Número de identificación", example = "7895456123a")
...
//    @ApiModelProperty(notes = "Persona de referencia (Objeto)", example = "JuanPerez")
