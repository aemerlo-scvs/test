...
public class LastObservedCaseDhlDtoSerialize extends StdSerializer<LastObservedCaseDhlDTO> {

    public LastObservedCaseDhlDtoSerialize(){
        this(null);
    }

    protected LastObservedCaseDhlDtoSerialize(Class<LastObservedCaseDhlDTO> t) {
        super(t);
    }

    @Override
    public void serialize(LastObservedCaseDhlDTO value, JsonGenerator jgen, SerializerProvider provider) throws IOException {
