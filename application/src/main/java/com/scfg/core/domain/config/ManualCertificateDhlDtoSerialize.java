...
public class ManualCertificateDhlDtoSerialize extends StdSerializer<ManualCertificateDhlDTO> {

    public ManualCertificateDhlDtoSerialize() {
        this(null);
    }

    protected ManualCertificateDhlDtoSerialize(Class<ManualCertificateDhlDTO> t) {
        super(t);
    }

    @Override
    public void serialize(ManualCertificateDhlDTO value, JsonGenerator jgen, SerializerProvider provider) throws IOException {
        ...
        jgen.writeObjectField("ESTATURA", value.getESTATURA());
