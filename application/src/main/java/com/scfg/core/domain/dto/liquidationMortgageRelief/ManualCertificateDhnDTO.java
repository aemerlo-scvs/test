...
import com.scfg.core.domain.config.ManualCertificateDhnDtoSerialize;
...
@Setter
@Getter
@JsonSerialize(using = ManualCertificateDhnDtoSerialize.class)
public class ManualCertificateDhnDTO {
    ...
    @JsonProperty("ESTATURA_CM")
    private Double ESTATURA_CM;
    ...
    public ManualCertificateDhnDTO(){}

    @Builder
    public ManualCertificateDhnDTO(String NRO_DJS_MANUAL, String TIPO_POLIZA, LocalDate FECHA_LLENADO_DJS, Long NRO_OPERACION, String NOMBRE_COMPLETO, String CI, LocalDate FECHA_NACIMIENTO, String GENERO, String NACIONALIDAD, Double PESO, Double ESTATURA_CM, String GESTOR, String AGENCIA, String MONEDA, Double MONTO_SOLICITADO_BS, Double MONTO_ACUMULADO_BS, Integer PLAZO_CREDITO, Integer DIAS_MESES_ANHOS, String TIPO_CREDITO, LocalDate FECHA_ACEPTACION, String NRO_CERTIFICADO,String ESTADO_SOLICITUD, LocalDate FECHA_DESEMBOLSO, Double VALOR_ASEGURADO,  Double TASAX, String COBERTURA, Double TASA_EXTRAPRIMA, Double PRIMA_BS, Double TASA_EXTRAPRIMA_BANCO, Double EXTRAPRIMA_BS) {
    ...
    public ManualCertificateDhnDTO hiddenRelationship(){
