...
@Getter
@Setter
@JsonSerialize(using = LastObservedCaseDhlDtoSerialize.class)
public class LastObservedCaseDhlDTO {
    ...
    public LastObservedCaseDhlDTO(){}

    @Builder
    public LastObservedCaseDhlDTO(Long NRO,String NRO_SOLICITUD, Long NRO_OPERACION, String NOMBRE, String NRO_CI, LocalDate FECHA_NACIMIENTO, Double SALDO, LocalDate FECHA_DESEMBOLSO, Double CAPITAL_EXCLUIDO, String TIPO_OBSERVACION) {
        this.NRO = NRO;
    ...
    public LastObservedCaseDhlDTO hiddenRelationship(){
