...
@Entity
@Table(name = HelpersConstants.TABLE_MONTHLY_DISBURSEMENT)
@Data // change for getter and setter
@AllArgsConstructor
@NoArgsConstructor
@Where(clause = HelpersConstants.FILTER_ACTIVE_RECORDS_FOR_PERSIST)
@SuperBuilder
public class MonthlyDisbursementJpaEntity extends BaseJpaEntity {
    ...
    */
    ...
    @PrePersist
    void prePersists(){
        caseStatus = MonthlyDisbursementCaseStatusEnum.PendingValidation
                .getIdentifier();
    }
