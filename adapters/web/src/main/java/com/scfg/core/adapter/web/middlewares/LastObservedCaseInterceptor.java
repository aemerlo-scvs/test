...
public class LastObservedCaseInterceptor implements HandlerInterceptor {
        ...
        if (req.getMethod().equalsIgnoreCase("POST")) {
            ...
            if (policyTypeCodeReference.equals(ClassifierEnum.RegulatedDH_PolicyType
                ...
                existsInformation = !mortgageReliefItemUseCase.getMortgageReliefItemByIDs(
                        ...
                        .isEmpty();
                persistenceResponse.setResourceName(LastObservedCaseDhlDTO.class.getSimpleName());
                ...
                existsInformation = !mortgageReliefItemUseCase.getMortgageReliefItemByIDs(
                        ...
                        insurancePolicyHolderId)
                        .isEmpty();
                persistenceResponse.setResourceName(LastObservedCaseDhnDTO.class.getSimpleName());
            }
