...
public class SubscriptionTrackingInterceptor implements HandlerInterceptor {
        ...
        if (req.getMethod().equalsIgnoreCase("POST")) {
            ...
            if (policyTypeCodeReference.equals(ClassifierEnum.RegulatedDH_PolicyType
                ...
                existsInformation = !mortgageReliefItemUseCase.getMortgageReliefItemByIDs(
                        ...
                        .isEmpty();
                persistenceResponse.setResourceName(SubscriptionTrackingDhlDTO.class.getSimpleName());
                ...
                existsInformation = !mortgageReliefItemUseCase.getMortgageReliefItemByIDs(
                        ...
                        insurancePolicyHolderId)
                        .isEmpty();
                persistenceResponse.setResourceName(SubscriptionTrackingDhnDTO.class.getSimpleName());
            }
