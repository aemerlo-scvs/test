...
public class OldMonthlyDisbursementInterceptor implements HandlerInterceptor {
        ...
        if (req.getMethod().equalsIgnoreCase("POST")) {
            ...
            if (policyTypeCodeReference.equals(ClassifierEnum.RegulatedDH_PolicyType
                ...
                existsInformation = !mortgageReliefItemUseCase.getMortgageReliefItemByIDs(
                        ...
                        .isEmpty();
                persistenceResponse.setResourceName(OldMonthlyDisbursementCreditLineDhlDTO.class.getSimpleName());
                ...
                existsInformation = !mortgageReliefItemUseCase.getMortgageReliefItemByIDs(
                        ...
                        insurancePolicyHolderId)
                        .isEmpty();
                persistenceResponse.setResourceName(OldMonthlyDisbursementCreditLineDhnDTO.class.getSimpleName());
            }
