...
public class SinisterInterceptor implements HandlerInterceptor {
        ...
        if (req.getMethod().equalsIgnoreCase("POST")) {
            ...
            if (policyTypeCodeReference.equals(ClassifierEnum.RegulatedDH_PolicyType
                ...
                existsInformation = !mortgageReliefItemUseCase.getMortgageReliefItemByIDs(
                        ...
                        .isEmpty();
                persistenceResponse.setResourceName(SinisterDhlDTO.class.getSimpleName());
                ...
                existsInformation = !mortgageReliefItemUseCase.getMortgageReliefItemByIDs(
                        ...
                        insurancePolicyHolderId)
                        .isEmpty();
                persistenceResponse.setResourceName(SinisterDhnDTO.class.getSimpleName());
            }
