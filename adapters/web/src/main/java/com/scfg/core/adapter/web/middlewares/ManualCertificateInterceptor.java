...
public class ManualCertificateInterceptor implements HandlerInterceptor {
        ...
        if (req.getMethod().equalsIgnoreCase("POST")) {
            ...
            if (policyTypeCodeReference.equals(ClassifierEnum.RegulatedDH_PolicyType
                ...
                existsInformation = !mortgageReliefItemUseCase.getMortgageReliefItemByIDs(
                        ...
                        .isEmpty();
                persistenceResponse.setResourceName(ManualCertificateDhlDTO.class.getSimpleName());
                ...
                existsInformation = !mortgageReliefItemUseCase.getMortgageReliefItemByIDs(
                        ...
                        insurancePolicyHolderId)
                        .isEmpty();
                persistenceResponse.setResourceName(ManualCertificateDhnDTO.class.getSimpleName());
            }
